...
// 			const lastId =
// 				categories.length > 0
// 					? Math.max(...categories.map((c) => Number.parseInt(c.id.substring(1), 10)))
// 					: 0;
...
// 		setCurrentCategory((prev) => ({ ...prev, status: e.target.checked }));
// 	};
...
// 				setCategories((prev) =>
// 					prev.map((category) =>
// 						category.id === currentCategory.id ? response.category : category,
// 					),
// 				);
...
// 										{currentCategory.status ? "ໃຊ້ງານ" : "ບໍ່ໃຊ້ງານ"}
// 									</Typography>
// 								}
// 							/>
// 						</Box>
...
// 	/**
// 	 * ກຳນົດ Table headers ຕາມລະດັບໝວດໝູ່
// 	 */
// 	const getTableHeaders = () => {
// 		if (!currentCategory) {
// 			// ໝວດໝູ່ແມ່ (ມີໝວດໝູ່ຍ່ອຍ)
// 			return [
// 				{
// 					id: "id",
// 					// label: "ລະຫັດປະເພດສິນຄ້າ",
...
// 					}}
// 				>
// 					ຈັດການປະເພດສິນຄ້າ {currentCategory && `- ${currentCategory.name}`}
// 				</Typography>
...
// 										.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
// 										.map((category, index) => {
// 											// ນັບຈຳນວນໝວດໝູ່ຍ່ອຍຂອງແຕ່ລະໝວດໝູ່ (ສຳລັບໝວດໝູ່ແມ່ເທົ່ານັ້ນ)
// 											const subCount = !currentCategory
...
// 													{/* ໝວດໝູ່ຍ່ອຍ (ສຳລັບໝວດໝູ່ແມ່ເທົ່ານັ້ນ) */}
// 													{!currentCategory && (
// 														<TableCell
// 															align="center"
// 															style={{
...
// 													{/* ສະຖານະ (ສຳລັບໝວດໝູ່ຍ່ອຍເທົ່ານັ້ນ) */}
// 													{currentCategory && (
// 														<TableCell
// 															align="center"
// 															style={{
...
// 														align="center"
// 														style={{
// 															width: currentCategory
// 																? tableHeaders[3].width
// 																: tableHeaders[3].width,
// 														}}
// 													>
// 														<Box
...
// 																	p: 1,
// 																}}
// 																disabled={!currentCategory && subCount > 0}
// 															>
// 																<DeleteIcon fontSize="small" />
// 															</IconButton>
// 														</Box>
