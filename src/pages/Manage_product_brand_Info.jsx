// // frontend/src/pages/manage_product_brand_Info.jsx
...
// // ຕອນນີ້ເຮົາຍັງບໍ່ມີ service ສຳລັບ brand ເທື່ອ ເຮົາຈະສ້າງຂໍ້ມູນຕົວຢ່າງກ່ອນ
// // ໃນອະນາຄົດຈະສ້າງ brandService ຄືກັນກັບ supplierService
...
// 			name: "Apple",
// 			status: true,
// 			createdDate: "2025-04-01 10:00:00",
// 		},
// 		{
// 			id: "B002",
// 			name: "Samsung",
// 			status: true,
// 			createdDate: "2025-04-01 11:30:00",
// 		},
// 		{
// 			id: "B003",
// 			name: "Sony",
// 			status: false,
// 			createdDate: "2025-04-02 09:15:00",
// 		},
// 		{
// 			id: "B004",
// 			name: "LG",
// 			status: true,
// 			createdDate: "2025-04-03 14:20:00",
// 		},
// 		{
// 			id: "B005",
// 			name: "Huawei",
// 			status: false,
// 			createdDate: "2025-04-04 16:45:00",
// 		},
// 	]);
...
// 	/**
// 	 * 1) ດຶງຂໍ້ມູນຍີ່ຫໍ້ສິນຄ້າທັງໝົດ (ຕອນນີ້ໃຊ້ຂໍ້ມູນຕົວຢ່າງ)
// 	 */
...
// 		try {
// 			// ຕອນນີ້ບໍ່ມີ API call ເທື່ອ, ເຮົາໃຊ້ຂໍ້ມູນຕົວຢ່າງແທນ
// 			// ໃນອະນາຄົດຈະເປັນ: const data = await brandService.getAllBrands();

// 			// ຈຳລອງການໂຫຼດຂໍ້ມູນ
// 			setTimeout(() => {
// 				// ໃຊ້ຂໍ້ມູນທີ່ມີຢູ່ແລ້ວ, ບໍ່ຕ້ອງ setBrands ຄືນໃໝ່
// 				setLoading(false);
// 			}, 500);
// 		} catch (err) {
// 			console.error("Error fetching brands:", err);
// 			setError("ບໍ່ສາມາດດຶງຂໍ້ມູນຍີ່ຫໍ້ສິນຄ້າໄດ້");
// 			showNotification("ບໍ່ສາມາດດຶງຂໍ້ມູນຍີ່ຫໍ້ສິນຄ້າໄດ້", "error");
// 			setLoading(false);
// 		}
// 	}, []);
...
// 			if (editMode) {
// 				// Update existing brand (ຕອນນີ້ບໍ່ມີການເຊື່ອມຕໍ່ API)
// 				// ໃນອະນາຄົດຈະເປັນ: const response = await brandService.updateBrand(...)

// 				// ອັບເດດລາຍການຍີ່ຫໍ້ສິນຄ້າໃນ state
// 				setBrands((prev) =>
// 					prev.map((brand) =>
...
// 			} else {
// 				// Create new brand (ຕອນນີ້ບໍ່ມີການເຊື່ອມຕໍ່ API)
// 				// ໃນອະນາຄົດຈະເປັນ: const response = await brandService.createBrand(...)

// 				// ເພີ່ມລາຍການຍີ່ຫໍ້ສິນຄ້າໃໝ່
// 				setBrands((prev) => [currentBrand, ...prev]);
...
// 			showNotification("ບໍ່ສາມາດບັນທຶກຂໍ້ມູນຍີ່ຫໍ້ສິນຄ້າໄດ້", "error");
// 		}
// 	};
...
// 			try {
// 				// ຕອນນີ້ບໍ່ມີການເຊື່ອມຕໍ່ API
// 				// ໃນອະນາຄົດຈະເປັນ: await brandService.deleteBrand(id);
...
// 				showNotification("ບໍ່ສາມາດລຶບຍີ່ຫໍ້ສິນຄ້າໄດ້", "error");
// 			}
// 		}
// 	};
...
// 		// ຕອນນີ້ບໍ່ມີການຄົ້ນຫາໂດຍໃຊ້ API, ໃຊ້ຂໍ້ມູນທີ່ກັ່ນຕອງແລ້ວຈາກ state
// 		// ໃນອະນາຄົດຈະເປັນ: const results = await brandService.searchBrands(searchQuery);
// 	};
